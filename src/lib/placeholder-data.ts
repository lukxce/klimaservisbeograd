...
export const products: ProductItem[] = [
  {
    ...
    shortDescription: "Tih inverter uređaj sa upravljanjem preko telefona, dobar izbor za dnevni boravak ili spavaću sobu.",
    featured: true,
    specs: {
    ...
    features: [
      "Inverter kompresor drži temperaturu stabilnom uz manju potrošnju struje",
      "Upravljanje preko Wi-Fi aplikacije sa bilo kog mesta",
      "Rad gotovo bez šuma, pogodan za spavaću sobu",
      "Automatski nastavlja rad posle nestanka struje",
      "Ugrađen filter zadržava prašinu i čini vazduh čistijim",
    ],
  },
  {
    ...
    oldPrice: 520,
    installationIncluded: true,
    shortDescription: "Jedan od energetski najštedljivijih modela u ponudi, pogodan za prostorije do oko 35 kvadrata.",
    featured: true,
    specs: {
      energyClassCooling: "A+++",
      energyClassHeating: "A++",
    ...
    features: [
      "Energetska klasa A+++ znači primetno niži račun za struju u sezoni",
      "I-ECO režim dodatno smanjuje potrošnju kad nije potrebna puna snaga",
      "Radi pouzdano i na spoljnim temperaturama do minus 15 stepeni",
      "Funkcija samočišćenja isparivača sprečava vlagu i neprijatan miris",
      "Upravljanje putem aplikacije sa telefona",
    ],
  },
  {
    ...
    price: 780,
    installationIncluded: true,
    shortDescription: "Jak i pouzdan uređaj japanske proizvodnje, prava klasa za veće stanove ili manji poslovni prostor.",
    featured: true,
    specs: {
      energyClassCooling: "A++",
      energyClassHeating: "A+",
    ...
    features: [
      "Provereni Daikin kompresor sa dugogodišnjom reputacijom pouzdanosti",
      "Econo režim ograničava potrošnju struje bez gubitka komfora",
      "Tih rad uz stabilno hlađenje i grejanje tokom cele godine",
      "Sam se ponovo pokreće posle nestanka struje, bez ručnog podešavanja",
      "Kapacitet dovoljan za veći dnevni boravak ili kancelarijski prostor",
    ],
  },
  {
    ...
    price: 380,
    installationIncluded: true,
    shortDescription: "Kompaktan model za manje prostorije, spavaće sobe ili radne kabinete, uz tih rad i brzo hlađenje.",
    specs: {
      energyClassCooling: "A++",
      energyClassHeating: "A+",
      gasType: "R32",
    ...
    features: [
      "Manje dimenzije unutrašnje jedinice, lako se uklapa u manji prostor",
      "Rad gotovo bez zvuka, pogodan za spavaću sobu",
      "I-Feel senzor meri stvarnu temperaturu tamo gde se korisnik nalazi",
      "Brzo dostiže zadatu temperaturu odmah po uključivanju",
    ],
  },
  {
    ...
    installationIncluded: true,
    featured: true,
    shortDescription: "Najjači model u ponudi, namenjen velikim ili otvorenim prostorima gde manji uređaj jednostavno ne bi stigao.",
    specs: {
      energyClassCooling: "A++",
      energyClassHeating: "A+",
      gasType: "R32",
    ...
    features: [
      "Veliki kapacitet pokriva otvoren dnevni boravak sa kuhinjom ili poslovni prostor",
      "DUAL Inverter kompresor brzo hladi i radi tiho na dužu stazu",
      "Upravljanje preko LG ThinQ aplikacije",
      "Auto Clean funkcija suši isparivač posle rada i sprečava buđ",
    ],
  },
  {
    slug: "vivax-cool-12k",
    ...
    price: 420,
    installationIncluded: true,
    shortDescription: "Pristupačan inverter uređaj za stan ili kuću, bez nepotrebnih dodataka, samo pouzdano hlađenje i grejanje.",
    specs: {
      energyClassCooling: "A++",
      energyClassHeating: "A+",
      gasType: "R32",
    ...
    features: [
      "Najpovoljnija opcija u ponudi uz zadržanu inverter tehnologiju",
      "Četiri režima rada: hlađenje, grejanje, sušenje vazduha i ventilacija",
      "Jednostavno upravljanje klasičnim daljinskim, bez nepotrebnih podešavanja",
      "Dobar izbor kad je budžet prioritet, a kvalitet i dalje mora biti na nivou",
    ],
  },
  {
    slug: "vivax-cool-9k",
    ...
    price: 350,
    installationIncluded: true,
    shortDescription: "Manja verzija Cool serije, za sobe do 20 kvadrata gde nije potreban veliki kapacitet.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Inverter tehnologija u pristupačnoj klasi",
      "Dovoljan kapacitet za manju spavaću sobu ili radnu sobu",
      "Četiri režima rada uključujući sušenje vazduha",
    ],
  },
  {
    slug: "vivax-cool-18k",
    title: "Vivax Cool 18k",
    brand: "Vivax",
    type: "Zidni",
    btu: 18000,
    price: 640,
    installationIncluded: true,
    shortDescription: "Jača verzija Cool serije za veće prostorije, uz istu jednostavnu i pouzdanu konstrukciju.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Kapacitet za dnevni boravak srednje veličine",
      "Inverter kompresor bez nepotrebnih dodataka koji podižu cenu",
      "Isti jednostavan daljinski kao kod manjih modela iz serije",
    ],
  },
  {
    slug: "vivax-r-design-silver-9k",
    title: "Vivax R Design Silver 9k",
    brand: "Vivax",
    type: "Zidni",
    btu: 9000,
    price: 390,
    installationIncluded: true,
    shortDescription: "Dizajnerska linija sa srebrnom završnicom kućišta, za one kojima je izgled unutrašnje jedinice bitan.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 3 godine" },
    features: [
      "Metalik završnica kućišta odudara od uobičajenog belog plastičnog dizajna",
      "Wi-Fi upravljanje uključeno i u ovoj cenovnoj klasi",
      "Ista pouzdana inverter osnova kao standardna Cool serija",
    ],
  },
  {
    slug: "vivax-r-design-silver-12k",
    title: "Vivax R Design Silver 12k",
    brand: "Vivax",
    type: "Zidni",
    btu: 12000,
    price: 440,
    installationIncluded: true,
    shortDescription: "Veća verzija dizajnerske Silver linije, za dnevni boravak koji treba i da izgleda drugačije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 3 godine" },
    features: [
      "Srebrna završnica kućišta uz standardni kapacitet za dnevni boravak",
      "Upravljanje preko aplikacije",
      "Inverter kompresor za stabilnije hlađenje od on/off modela",
    ],
  },
  {
    slug: "vivax-q-design-12k",
    title: "Vivax Q Design 12k",
    brand: "Vivax",
    type: "Zidni",
    btu: 12000,
    price: 460,
    installationIncluded: true,
    shortDescription: "Zaobljena, kompaktnija linija kućišta unutrašnje jedinice, uz standardan kapacitet od 12000 BTU.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 3 godine" },
    features: [
      "Kompaktnije i zaobljenije kućište od standardne Cool serije",
      "Wi-Fi upravljanje putem mobilne aplikacije",
      "Dovoljan kapacitet za standardnu spavaću sobu ili manji dnevni boravak",
    ],
  },
  {
    slug: "vivax-acp-r-24k",
    title: "Vivax ACP-R 24k",
    brand: "Vivax",
    type: "Zidni",
    btu: 24000,
    price: 890,
    installationIncluded: true,
    shortDescription: "Najjači Vivax model u ponudi, za veće otvorene prostore uz i dalje pristupačnu cenu u odnosu na konkurenciju te klase.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 3 godine" },
    features: [
      "Kapacitet za veliki dnevni boravak ili manji poslovni prostor",
      "Upravljanje preko aplikacije sa telefona",
      "Povoljnija opcija u odnosu na premium brendove iste snage",
    ],
  },
  {
    slug: "daikin-sensira-12k",
    title: "Daikin Sensira 12k",
    brand: "Daikin",
    type: "Zidni",
    btu: 12000,
    price: 480,
    installationIncluded: true,
    shortDescription: "Standardna veličina iz Sensira linije, ulazna Daikin klasa uz proverenu japansku pouzdanost.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Provereni Daikin kompresor u srednjoj cenovnoj klasi",
      "Econo režim za smanjenu potrošnju bez gubitka komfora",
      "Dovoljan kapacitet za standardnu spavaću sobu ili radnu sobu",
    ],
  },
  {
    slug: "daikin-sensira-9k",
    title: "Daikin Sensira 9k",
    brand: "Daikin",
    type: "Zidni",
    btu: 9000,
    price: 390,
    installationIncluded: true,
    shortDescription: "Najmanja verzija Sensira linije, ulaz u Daikin kvalitet po pristupačnijoj ceni.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Kompaktan kapacitet za manju sobu ili kancelariju",
      "Ista japanska pouzdanost kao kod jačih modela iz linije",
      "Tih rad pogodan za spavaću sobu",
    ],
  },
  {
    slug: "daikin-comfora-12k",
    title: "Daikin Comfora 12k",
    brand: "Daikin",
    type: "Zidni",
    btu: 12000,
    price: 520,
    installationIncluded: true,
    shortDescription: "Viša klasa od Sensira linije, sa boljom energetskom efikasnošću i Wi-Fi upravljanjem u standardu.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Energetska klasa A+++ za niži račun struje u sezoni",
      "Wi-Fi upravljanje uključeno u standardnu opremu",
      "Tiši rad unutrašnje jedinice u odnosu na ulaznu Sensira liniju",
    ],
  },
  {
    slug: "daikin-perfera-18k",
    title: "Daikin Perfera 18k",
    brand: "Daikin",
    type: "Zidni",
    btu: 18000,
    price: 890,
    installationIncluded: true,
    shortDescription: "Vrhunska Daikin linija za veće prostorije, sa najvišom energetskom klasom u ponudi proizvođača.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Najviša energetska klasa A+++ i za hlađenje i za grejanje",
      "Produžena garancija od tri plus sedam godina",
      "Napredan filter vazduha uz tih rad na velikom kapacitetu",
    ],
  },
  {
    slug: "daikin-stylish-12k",
    title: "Daikin Stylish 12k",
    brand: "Daikin",
    type: "Zidni",
    btu: 12000,
    price: 640,
    installationIncluded: true,
    shortDescription: "Dizajnerska Daikin linija sa zaobljenim kućištem, za dnevni boravak gde izgled uređaja nije nebitan.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Prepoznatljivo zaobljeno kućište, dostupno u više boja",
      "Vrhunska energetska efikasnost u obe sezone",
      "Wi-Fi upravljanje i produžena garancija",
    ],
  },
  {
    slug: "daikin-alira-x-9k",
    title: "Daikin Alira X 9k",
    brand: "Daikin",
    type: "Zidni",
    btu: 9000,
    price: 470,
    installationIncluded: true,
    shortDescription: "Kompaktna dizajnerska linija za manje prostorije, uz istu vrhunsku energetsku efikasnost kao veći modeli.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Tanko, kompaktno kućište prilagođeno manjim prostorijama",
      "Wi-Fi upravljanje sa telefona",
      "Visoka energetska klasa uprkos manjem kapacitetu",
    ],
  },
  {
    slug: "mitsubishi-msz-ap25-9k",
    title: "Mitsubishi MSZ-AP25 9k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 9000,
    price: 400,
    installationIncluded: true,
    shortDescription: "Ulazni model u Mitsubishi ponudi, standardna pouzdanost japanskog proizvođača za manju prostoriju.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Standardna Mitsubishi Electric pouzdanost u pristupačnijoj klasi",
      "Tih rad pogodan za spavaću sobu",
      "Dovoljan kapacitet za manju sobu ili kancelariju",
    ],
  },
  {
    slug: "mitsubishi-msz-ap35-12k",
    title: "Mitsubishi MSZ-AP35 12k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 12000,
    price: 500,
    installationIncluded: true,
    shortDescription: "Standardna Mitsubishi serija u srednjem kapacitetu, dobar izbor za dnevnu sobu prosečne veličine.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Provereni AP kompresor sa dugom istorijom na tržištu",
      "Stabilno hlađenje i grejanje bez naglih oscilacija",
      "Kapacitet dovoljan za standardan dnevni boravak",
    ],
  },
  {
    slug: "mitsubishi-msz-ap50-18k",
    title: "Mitsubishi MSZ-AP50 18k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 18000,
    price: 820,
    installationIncluded: true,
    shortDescription: "Jača verzija AP serije za veće prostorije, uz mogućnost dodatnog Wi-Fi adaptera.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Kapacitet za veći dnevni boravak ili manji poslovni prostor",
      "Wi-Fi upravljanje dostupno preko dodatnog adaptera",
      "Ista pouzdana konstrukcija kao manji modeli iz AP serije",
    ],
  },
  {
    slug: "mitsubishi-msz-ln25-9k",
    title: "Mitsubishi MSZ-LN25 9k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 9000,
    price: 620,
    installationIncluded: true,
    shortDescription: "Premium dizajnerska Kirigamine linija, sa metalik kućištem i vrhunskom energetskom efikasnošću.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Prepoznatljivo metalik kućište, dostupno u više boja",
      "Vrhunska energetska klasa A+++ u obe sezone",
      "Produžena garancija od tri plus sedam godina",
    ],
  },
  {
    slug: "mitsubishi-msz-ln35-12k",
    title: "Mitsubishi MSZ-LN35 12k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 12000,
    price: 690,
    installationIncluded: true,
    shortDescription: "Veća verzija premium Kirigamine linije, za dnevni boravak koji treba da izgleda kao deo enterijera, ne kao uređaj.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Dizajn koji se uklapa u enterijer bolje od standardnog belog kućišta",
      "Wi-Fi upravljanje i vrhunska efikasnost",
      "Produžena garancija na kompresor",
    ],
  },
  {
    slug: "mitsubishi-muz-fh35-12k",
    title: "Mitsubishi MUZ-FH35 12k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 12000,
    price: 780,
    installationIncluded: true,
    shortDescription: "Deluxe linija fokusirana na grejanje, radi efikasno i na jako niskim spoljnim temperaturama.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Efikasno grejanje i na spoljnim temperaturama do minus 25 stepeni",
      "Dobar izbor ako se klima koristi kao dopuna ili zamena za grejanje zimi",
      "Wi-Fi upravljanje i produžena garancija na kompresor",
    ],
  },
  {
    slug: "mitsubishi-msz-bt35-18k",
    title: "Mitsubishi MSZ-BT35 18k",
    brand: "Mitsubishi",
    type: "Zidni",
    btu: 18000,
    price: 750,
    installationIncluded: true,
    shortDescription: "Standardna serija u većem kapacitetu, bez dizajnerskih dodataka, samo pouzdano hlađenje i grejanje.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A++", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Kapacitet za veći dnevni boravak bez premium cene",
      "Provereni Mitsubishi kompresor",
      "Standardno kućište bez dizajnerskih doplata",
    ],
  },
  {
    slug: "gree-pular-eco-9k",
    title: "Gree Pular Eco 9k",
    brand: "Gree",
    type: "Zidni",
    btu: 9000,
    price: 400,
    installationIncluded: true,
    shortDescription: "Manja verzija Pular Eco serije, za sobe do 20 kvadrata uz isto Wi-Fi upravljanje kao veći modeli.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Inverter tehnologija u kompaktnijem kapacitetu",
      "Wi-Fi upravljanje putem aplikacije",
      "Tih rad pogodan za spavaću sobu",
    ],
  },
  {
    slug: "gree-pular-eco-18k",
    title: "Gree Pular Eco 18k",
    brand: "Gree",
    type: "Zidni",
    btu: 18000,
    price: 700,
    installationIncluded: true,
    shortDescription: "Jača verzija Pular Eco serije za veće prostorije, uz isti Wi-Fi standard kao ceo model.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Kapacitet za veći dnevni boravak ili otvoren prostor",
      "Wi-Fi upravljanje sa telefona",
      "Filter za prečišćavanje vazduha kao i kod manjih modela",
    ],
  },
  {
    slug: "gree-bora-12k",
    ...
    price: 440,
    installationIncluded: true,
    shortDescription: "Pristupačnija Gree linija bez Wi-Fi funkcije, za korisnike kojima je bitna samo cena i pouzdanost.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Inverter tehnologija u budžetskoj klasi",
      "Standardan kapacitet za dnevni boravak ili spavaću sobu",
      "Klasičan daljinski upravljač, bez dodatnih funkcija",
    ],
  },
  {
    slug: "gree-amber-9k",
    ...
    price: 360,
    installationIncluded: true,
    shortDescription: "Najpristupačniji Gree model u ponudi, za manju prostoriju gde je cena glavni kriterijum.",
    specs: { energyClassCooling: "A+", energyClassHeating: "A", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Ulazna cenovna klasa uz i dalje inverter kompresor",
      "Dovoljan kapacitet za manju sobu ili kancelariju",
      "Jednostavno upravljanje bez nepotrebnih funkcija",
    ],
  },
  {
    slug: "gree-fairy-12k",
    title: "Gree Fairy 12k",
    brand: "Gree",
    type: "Zidni",
    btu: 12000,
    price: 460,
    installationIncluded: true,
    shortDescription: "Kompaktnija dizajnerska linija sa Wi-Fi upravljanjem, za korisnike kojima je bitan i izgled unutrašnje jedinice.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Kompaktnije i zaobljenije kućište od standardne Pular Eco linije",
      "Wi-Fi upravljanje uključeno",
      "Standardan kapacitet za dnevni boravak srednje veličine",
    ],
  },
  {
    slug: "gree-comfort-x-24k",
    title: "Gree Comfort X 24k",
    brand: "Gree",
    type: "Zidni",
    btu: 24000,
    price: 950,
    installationIncluded: true,
    shortDescription: "Najjači Gree model u ponudi, za velike otvorene prostore ili poslovne prostorije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Veliki kapacitet za otvoren dnevni boravak ili poslovni prostor",
      "Wi-Fi upravljanje sa telefona",
      "Inverter kompresor za stabilan rad na dužim ciklusima",
    ],
  },
  {
    slug: "lg-dualcool-18k",
    title: "LG DualCool 18k",
    brand: "LG",
    type: "Zidni",
    btu: 18000,
    price: 830,
    installationIncluded: true,
    shortDescription: "Srednja veličina iz DualCool serije, za veći dnevni boravak koji ne zahteva najjači model.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "DUAL Inverter kompresor za brzo hlađenje i tih rad",
      "Wi-Fi upravljanje putem LG ThinQ aplikacije",
      "Kapacitet za veći dnevni boravak bez cene 24k modela",
    ],
  },
  {
    slug: "lg-dualcool-12k",
    title: "LG DualCool 12k",
    brand: "LG",
    type: "Zidni",
    btu: 12000,
    price: 520,
    installationIncluded: true,
    shortDescription: "Standardna veličina DualCool serije, dobar balans cene i kapaciteta za prosečnu prostoriju.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "DUAL Inverter tehnologija u standardnom kapacitetu",
      "Upravljanje preko LG ThinQ aplikacije",
      "Auto Clean funkcija sprečava buđ u isparivaču",
    ],
  },
  {
    slug: "lg-dualcool-9k",
    title: "LG DualCool 9k",
    brand: "LG",
    type: "Zidni",
    btu: 9000,
    price: 430,
    installationIncluded: true,
    shortDescription: "Najmanja verzija DualCool serije, za spavaću sobu ili manju kancelariju uz punu Wi-Fi funkcionalnost.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Ista DUAL Inverter tehnologija kao veći modeli iz serije",
      "Wi-Fi upravljanje putem aplikacije",
      "Tih rad pogodan za spavaću sobu",
    ],
  },
  {
    slug: "lg-artcool-12k",
    title: "LG Artcool 12k",
    brand: "LG",
    type: "Zidni",
    btu: 12000,
    price: 590,
    installationIncluded: true,
    shortDescription: "Dizajnerska LG linija sa staklenim prednjim panelom, za dnevni boravak gde izgled uređaja igra ulogu.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Staklen prednji panel umesto standardne plastike",
      "Viša energetska klasa od standardne DualCool serije",
      "Produžena garancija na kompresor",
    ],
  },
  {
    slug: "lg-standard-plus-9k",
    title: "LG Standard Plus 9k",
    brand: "LG",
    type: "Zidni",
    btu: 9000,
    price: 370,
    installationIncluded: true,
    shortDescription: "Ulazna LG serija bez Wi-Fi funkcije, za korisnike kojima je prioritet niža cena.",
    specs: { energyClassCooling: "A+", energyClassHeating: "A", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Pristupačna cena uz zadržan LG kvalitet izrade",
      "Dovoljan kapacitet za manju sobu",
      "Klasičan daljinski upravljač",
    ],
  },
  {
    slug: "lg-standard-plus-12k",
    title: "LG Standard Plus 12k",
    brand: "LG",
    type: "Zidni",
    btu: 12000,
    price: 410,
    installationIncluded: true,
    shortDescription: "Veća verzija ulazne LG serije, za standardnu prostoriju bez dodatnih funkcija koje podižu cenu.",
    specs: { energyClassCooling: "A+", energyClassHeating: "A", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Standardan kapacitet po pristupačnoj ceni",
      "Provereni LG kompresor bez suvišnih dodataka",
      "Jednostavno upravljanje",
    ],
  },
  {
    slug: "samsung-windfree-avant-9k",
    title: "Samsung WindFree Avant 9k",
    brand: "Samsung",
    type: "Zidni",
    btu: 9000,
    price: 480,
    installationIncluded: true,
    shortDescription: "WindFree tehnologija hladi bez direktnog strujanja vazduha na kožu, prijatnije za dugotrajno sedenje u blizini uređaja.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "WindFree režim hladi kroz hiljade mikro-otvora bez oštrog mlaza vazduha",
      "Wi-Fi upravljanje putem SmartThings aplikacije",
      "Visoka energetska klasa i produžena garancija",
    ],
  },
  {
    slug: "samsung-windfree-avant-12k",
    title: "Samsung WindFree Avant 12k",
    brand: "Samsung",
    type: "Zidni",
    btu: 12000,
    price: 560,
    installationIncluded: true,
    shortDescription: "Veća verzija WindFree Avant linije, za dnevni boravak gde više ljudi duže vremena sedi u blizini klime.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "WindFree tehnologija za hlađenje bez direktnog daška na telo",
      "Upravljanje preko SmartThings aplikacije",
      "Kapacitet prilagođen dnevnom boravku",
    ],
  },
  {
    slug: "samsung-windfree-elite-18k",
    title: "Samsung WindFree Elite 18k",
    brand: "Samsung",
    type: "Zidni",
    btu: 18000,
    price: 920,
    installationIncluded: true,
    shortDescription: "Vrhunska Samsung linija za veće prostorije, sa najvišom energetskom klasom u obe sezone.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Najviša energetska klasa A+++ i za hlađenje i za grejanje",
      "WindFree režim za komfor bez direktnog strujanja vazduha",
      "Produžena garancija od tri plus sedam godina",
    ],
  },
  {
    slug: "samsung-windfree-elite-24k",
    title: "Samsung WindFree Elite 24k",
    brand: "Samsung",
    type: "Zidni",
    btu: 24000,
    price: 1050,
    installationIncluded: true,
    shortDescription: "Najjači i najviše opremljen Samsung model u ponudi, za velike prostore koji traže premium rešenje.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A+++", gasType: "R32", wifi: true, warranty: "3 + 7 godina" },
    features: [
      "Veliki kapacitet uz vrhunsku energetsku efikasnost",
      "WindFree tehnologija čak i na najjačem modelu iz serije",
      "Produžena garancija na kompresor",
    ],
  },
  {
    slug: "samsung-luzon-9k",
    title: "Samsung Luzon 9k",
    brand: "Samsung",
    type: "Zidni",
    btu: 9000,
    price: 400,
    installationIncluded: true,
    shortDescription: "Standardna Samsung serija bez WindFree dodataka, za korisnike kojima je bitna cena, ne dizajnerske funkcije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Provereni Samsung kompresor u pristupačnijoj klasi",
      "Standardan kapacitet za manju sobu",
      "Bez WindFree tehnologije, ali uz istu osnovnu pouzdanost",
    ],
  },
  {
    slug: "samsung-luzon-12k",
    title: "Samsung Luzon 12k",
    brand: "Samsung",
    type: "Zidni",
    btu: 12000,
    price: 450,
    installationIncluded: true,
    shortDescription: "Veća verzija standardne Luzon serije, za prosečnu prostoriju bez premium doplata.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Standardan kapacitet po pristupačnijoj ceni od WindFree linije",
      "Provereni Samsung kvalitet izrade",
      "Klasično upravljanje daljinskim",
    ],
  },
  {
    slug: "samsung-maldives-12k",
    title: "Samsung Maldives 12k",
    brand: "Samsung",
    type: "Zidni",
    btu: 12000,
    price: 500,
    installationIncluded: true,
    shortDescription: "Srednja Samsung klasa sa Wi-Fi upravljanjem, između standardne Luzon serije i premium WindFree linije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Wi-Fi upravljanje uključeno u srednjoj cenovnoj klasi",
      "Standardan kapacitet za dnevni boravak",
      "Dobar balans cene i funkcionalnosti unutar Samsung ponude",
    ],
  },
  {
    slug: "midea-xtreme-save-9k",
    title: "Midea Xtreme Save 9k",
    brand: "Midea",
    type: "Zidni",
    btu: 9000,
    price: 380,
    installationIncluded: true,
    shortDescription: "Manja verzija energetski najštedljivije Midea linije, za sobu do 20 kvadrata.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Energetska klasa A+++ i u manjem kapacitetu",
      "Wi-Fi upravljanje putem aplikacije",
      "I-ECO režim za dodatnu uštedu struje",
    ],
  },
  {
    slug: "midea-xtreme-save-18k",
    title: "Midea Xtreme Save 18k",
    brand: "Midea",
    type: "Zidni",
    btu: 18000,
    price: 720,
    installationIncluded: true,
    shortDescription: "Jača verzija Xtreme Save linije, za veći prostor uz istu visoku energetsku klasu.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Visoka energetska efikasnost i u većem kapacitetu",
      "Wi-Fi upravljanje sa telefona",
      "Rad na niskim spoljnim temperaturama do minus 15 stepeni",
    ],
  },
  {
    slug: "midea-all-easy-pro-9k",
    title: "Midea All Easy Pro 9k",
    brand: "Midea",
    type: "Zidni",
    btu: 9000,
    price: 340,
    installationIncluded: true,
    shortDescription: "Najpristupačniji Midea model u ponudi, za manju prostoriju bez dodatnih funkcija.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Ulazna cenovna klasa uz osnovnu inverter tehnologiju",
      "Dovoljan kapacitet za manju sobu ili kancelariju",
      "Jednostavno upravljanje klasičnim daljinskim",
    ],
  },
  {
    slug: "midea-all-easy-pro-12k",
    title: "Midea All Easy Pro 12k",
    brand: "Midea",
    type: "Zidni",
    btu: 12000,
    price: 400,
    installationIncluded: true,
    shortDescription: "Veća verzija budžetske Midea serije, za standardnu prostoriju uz najnižu cenu u ponudi brenda.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Standardan kapacitet po najpristupačnijoj Midea ceni",
      "Osnovna inverter tehnologija bez dodatnih funkcija",
      "Dobar izbor kad je budžet glavni kriterijum",
    ],
  },
  {
    slug: "midea-aurora-12k",
    title: "Midea Aurora 12k",
    brand: "Midea",
    type: "Zidni",
    btu: 12000,
    price: 470,
    installationIncluded: true,
    shortDescription: "Dizajnerska Midea linija sa svetlećim prednjim panelom, za dnevni boravak koji treba i da izgleda drugačije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Prednji panel sa diskretnim LED osvetljenjem",
      "Wi-Fi upravljanje uključeno",
      "Standardan kapacitet za dnevni boravak srednje veličine",
    ],
  },
  {
    slug: "midea-mission-24k",
    title: "Midea Mission 24k",
    brand: "Midea",
    type: "Zidni",
    btu: 24000,
    price: 980,
    installationIncluded: true,
    shortDescription: "Najjači Midea model u ponudi, za veliki otvoren prostor ili poslovni prostor.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Veliki kapacitet za otvoren dnevni boravak ili poslovni prostor",
      "Wi-Fi upravljanje sa telefona",
      "Inverter kompresor za stabilan rad na dugim ciklusima",
    ],
  },
  {
    slug: "hisense-comfort-12k",
    title: "Hisense Comfort 12k",
    brand: "Hisense",
    type: "Zidni",
    btu: 12000,
    price: 430,
    installationIncluded: true,
    shortDescription: "Veća verzija Comfort serije, za standardnu prostoriju uz istu jednostavnu konstrukciju kao manji model.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Standardan kapacitet za dnevni boravak ili veću spavaću sobu",
      "I-Feel senzor meri stvarnu temperaturu u prostoriji",
      "Tih rad kao i kod manjeg 9k modela",
    ],
  },
  {
    slug: "hisense-comfort-18k",
    title: "Hisense Comfort 18k",
    brand: "Hisense",
    type: "Zidni",
    btu: 18000,
    price: 730,
    installationIncluded: true,
    shortDescription: "Jača verzija Comfort serije za veće prostorije, po ceni nižoj od premium brendova iste klase.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: false, warranty: "2 + 5 godina" },
    features: [
      "Kapacitet za veći dnevni boravak bez premium cene",
      "I-Feel funkcija za precizno merenje temperature",
      "Brzo dostiže zadatu temperaturu pri pokretanju",
    ],
  },
  {
    slug: "hisense-comfort-24k",
    title: "Hisense Comfort 24k",
    brand: "Hisense",
    type: "Zidni",
    btu: 24000,
    price: 900,
    installationIncluded: true,
    shortDescription: "Najjača verzija Comfort serije, za velike prostore uz i dalje pristupačniju cenu od konkurencije.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Veliki kapacitet po ceni nižoj od premium brendova te snage",
      "Wi-Fi upravljanje dodato na najjačem modelu iz serije",
      "I-Feel senzor za tačnije održavanje zadate temperature",
    ],
  },
  {
    slug: "hisense-energy-9k",
    title: "Hisense Energy 9k",
    brand: "Hisense",
    type: "Zidni",
    btu: 9000,
    price: 360,
    installationIncluded: true,
    shortDescription: "Najpristupačniji Hisense model u ponudi, za manju prostoriju gde je cena glavni kriterijum.",
    specs: { energyClassCooling: "A+", energyClassHeating: "A", gasType: "R32", wifi: false, warranty: "2 + 3 godine" },
    features: [
      "Ulazna cenovna klasa uz osnovnu inverter tehnologiju",
      "Dovoljan kapacitet za manju sobu ili kancelariju",
      "Jednostavno upravljanje bez dodatnih funkcija",
    ],
  },
  {
    slug: "hisense-apple-pie-12k",
    title: "Hisense Apple Pie 12k",
    brand: "Hisense",
    type: "Zidni",
    btu: 12000,
    price: 480,
    installationIncluded: true,
    shortDescription: "Dizajnerska Hisense linija sa zaobljenim kućištem, za dnevni boravak gde izgled uređaja ima značaja.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Prepoznatljivo zaobljeno kućište, drugačije od standardnog dizajna",
      "Viša energetska klasa od standardne Comfort serije",
      "Wi-Fi upravljanje uključeno",
    ],
  },
  {
    slug: "hisense-eco-design-9k",
    title: "Hisense Eco Design 9k",
    brand: "Hisense",
    type: "Zidni",
    btu: 9000,
    price: 400,
    installationIncluded: true,
    shortDescription: "Kompaktna dizajnerska linija sa fokusom na energetsku efikasnost, za manju prostoriju.",
    specs: { energyClassCooling: "A++", energyClassHeating: "A+", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Fokus na energetsku efikasnost u kompaktnom kapacitetu",
      "Wi-Fi upravljanje sa telefona",
      "Tih rad pogodan za spavaću sobu",
    ],
  },
  {
    slug: "hisense-silentium-9k",
    title: "Hisense Silentium 9k",
    brand: "Hisense",
    type: "Zidni",
    btu: 9000,
    price: 420,
    installationIncluded: true,
    shortDescription: "Linija fokusirana na tih rad, za spavaću sobu gde je svaki decibel bitan.",
    specs: { energyClassCooling: "A+++", energyClassHeating: "A++", gasType: "R32", wifi: true, warranty: "2 + 5 godina" },
    features: [
      "Posebno tih rad unutrašnje jedinice, ispod nivoa standardnih modela",
      "Visoka energetska klasa uz nizak nivo buke",
      "Wi-Fi upravljanje uključeno",
    ],
  },
];
