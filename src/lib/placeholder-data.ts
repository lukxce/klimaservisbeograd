...
export const blogPosts: BlogPostItem[] = [
  ...
  {
    slug: "ugradnja-klime-kako-izgleda-montaza-korak-po-korak",
    title: "Ugradnja klime korak po korak: kako izgleda montaža i šta da pripremite",
    category: "montaza",
    excerpt:
      "Šta se tačno dešava onih tri do četiri sata dok ekipa radi, koje odluke morate doneti pre dolaska, i po čemu se poznaje da je montaža odrađena kako treba.",
    summary:
      "Montaža klime u beogradskom stanu traje tri do četiri sata i sastoji se od osam koraka, od dogovora o poziciji obe jedinice do puštanja u rad sa merenjem. Klijent pre dolaska ekipe treba da odluči gde ide unutrašnja i spoljna jedinica i da proveri pravila zgrade, dok su vakuumiranje sistema, izolacija cele trase i stalan pad odvoda kondenzata koraci po kojima se prepoznaje ispravno izvedena montaža.",
    keyTakeaways: [
      "Standardna montaža u stanu traje tri do četiri sata, a dve klime u istom stanu obično jedan radni dan",
      "Pozicija obe jedinice je jedina odluka koja se posle montaže teško menja, pa je vredi promisliti unapred",
      "Vakuumiranje sistema nije opcioni korak, i montaža bez njega skraćuje vek uređaja bez obzira na marku",
      "Odvod kondenzata mora imati stalan pad prema izlazu, jer se svaki uspon kasnije vraća kao vlaga u stanu",
      "Uredna montaža se završava merenjem pritiska i temperature, ne samo time što uređaj upali i duva hladno",
    ],
    publishedAt: "2026-08-18T11:00:00.000Z",
    coverImageUrl: "/images/blog/ugradnja-klime-kako-izgleda-montaza-korak-po-korak.webp",
    body: [
      p("Većina tekstova o ugradnji klime govori o ceni. To je razumljivo, jer je cena prvo pitanje, ali posle nje gotovo uvek sledi drugo: šta se zapravo dešava kad ekipa dođe, koliko to traje, koliko je prljav posao i šta ja treba da uradim pre toga. Ovaj tekst je odgovor na to drugo pitanje."),
      p("Opisan je tok standardne montaže u beogradskom stanu, korak po korak, sa naznakom gde se najčešće prave prečice. Ako znate šta treba da se desi, lakše ćete prepoznati i posao odrađen kako treba i onaj koji to nije, kod bilo kog izvođača."),
      h2("Pre dolaska ekipe: tri odluke koje su na vama"),
      p("Sve ostalo je naš posao, ali ove tri stvari je najbolje da promislite unapred, jer se posle montaže menjaju teško i uz trošak."),
      h3("1. Gde ide unutrašnja jedinica"),
      p("Osnovno pravilo je da vazduh treba da struji preko dužine prostorije, a ne da duva direktno u ljude. Najčešća greška je postavljanje jedinice iznad kreveta ili radnog stola, jer je tu zid slobodan. Rezultat je stalna promaja na jednom mestu i osećaj da klima hladi previše, iako je temperatura u sobi sasvim normalna."),
      p("Vredi razmisliti i o visini i o pristupu za kasnije čišćenje filtera. Jedinica postavljena tik ispod plafona u prostoriji sa visokim plafonima izgleda uredno, ali svako pranje filtera traži merdevine."),
      h3("2. Gde ide spoljna jedinica"),
      p("Ovo je odluka koja najviše utiče i na cenu i na kasnije održavanje. Spoljnoj jedinici treba slobodan protok vazduha sa svih strana, položaj koji nije po ceo dan na direktnom suncu, i pozicija sa koje izduvani vazduh ne ide prema tuđem ili vašem prozoru. Uz to, što je bliža unutrašnjoj jedinici, kraća je trasa i niža cena."),
      p("Najvažnije praktično pitanje je da li se do te pozicije može prići kasnije bez opreme za rad na visini. Jedinica na koju se lako izlazi sa terase se pere i servisira jednostavno, dok ona spuštena niz fasadu traži poseban izlazak pri svakom servisu."),
      h3("3. Da li zgrada ima pravila"),
      p("Deo zgrada u Beogradu ima pravila o poziciji i izgledu spoljnih jedinica, a u zaštićenim zonama i na fasadama pod zaštitom postoje i formalna ograničenja. Ovo je stvar koju je znatno lakše proveriti pre kupovine uređaja nego posle."),
      pl([
        "O tome šta je dozvoljeno i kakvi su rokovi pisali smo posebno, u tekstovima ",
        { text: "da li smete da postavite klimu na fasadu zgrade", href: "/blog/da-li-smete-da-postavite-klimu-na-fasadu-zgrade" },
        " i ",
        { text: "klima na fasadi: rokovi i kazne", href: "/blog/klima-na-fasadi-novi-rokovi-i-kazne" },
        ".",
      ]),
      h2("Kako teče montaža, korak po korak"),
      h3("Korak 1: obilazak i konačan dogovor o poziciji"),
      p("Prvih petnaest minuta ide na to da zajedno stanemo u prostoriju i potvrdimo pozicije obe jedinice, i da izmerimo stvarnu dužinu trase. Tek tada se zna da li posao ulazi u standardnu trasu do tri metra ili ima doplate po dužnom metru. Ako se pojavi razlika u odnosu na dogovor telefonom, kaže se odmah, pre nego što se dodirne zid."),
      h3("Korak 2: zaštita prostora"),
      p("Prostor ispod mesta bušenja se pokriva folijom, nameštaj u blizini se sklanja ili prekriva. Bušenje prodora kroz zid pravi prašinu i to je jedini prljav deo posla, pa se radi uz usisivač koji hvata prašinu na izlazu bušilice. Uredna ekipa ovo radi bez posebne molbe."),
      h3("Korak 3: montaža nosača i prodor kroz zid"),
      p("Nosač unutrašnje jedinice se postavlja u libelu, jer i mali nagib menja put kondenzata u koritu i može da napravi kapanje na jednu stranu. Prodor kroz zid se buši pod blagim nagibom naniže prema spolja, upravo zato da bi kondenzat imao prirodan pad. Ovaj detalj se ne vidi kad je posao gotov, a jedan je od najčešćih uzroka kasnijih problema sa vlagom."),
      p("Vreme ovog koraka najviše zavisi od zida. U novogradnji je prodor gotov za nekoliko minuta, dok debeo zid starije gradnje u centru ume da traži i pola sata."),
      h3("Korak 4: postavljanje spoljne jedinice"),
      p("Spoljna jedinica se postavlja na zidne nosače ili na noge, u libelu i sa razmakom od zida koji dozvoljava protok vazduha. Kod pozicija van domašaja terase ovo je deo posla koji zahteva opremu za rad na visini i osiguranje, i to je stavka koja se dogovara unapred, ne na licu mesta."),
      h3("Korak 5: instalaciona trasa"),
      p("Kroz prodor se provlače bakarne cevi, električni kabl i crevo za kondenzat, i to zajedno kao snop. Ključne stvari u ovom koraku su tri: da bakarne cevi budu izolovane po celoj dužini, obe cevi a ne samo jedna, da se cev ne prelomi pri savijanju, i da crevo za kondenzat ima stalan pad prema izlazu, bez ijednog uspona na putu."),
      p("Neizolovana ili delimično izolovana cev je najvidljiviji znak brzine na uštrb kvaliteta. Na neizolovanoj cevi se kondenzuje vlaga, koja zatim kaplje na fasadu ili u prostor iznad spuštenog plafona, a uređaj uz to gubi na efikasnosti."),
      h3("Korak 6: spajanje i vakuumiranje"),
      p("Ovo je najvažniji korak cele montaže i ujedno onaj koji se najčešće preskače kada se traži najniža cena. Posle dotezanja holendera na propisan moment, iz sistema se vakuum pumpom izvlači vazduh i vlaga, i to nekoliko desetina minuta, a ne dva minuta."),
      p("Razlog je jednostavan. Vazduh i vlaga zaostali u sistemu se mešaju sa uljem u kompresoru i vremenom stvaraju kiseline koje izjedaju unutrašnjost sistema. Posledica se ne vidi odmah nego kroz godinu ili dve, kao pad učinka, a zatim i kao kvar kompresora. Prečica u kojoj se sistem ne vakuumira nego se vazduh samo istisne freonom deluje isto na dan montaže i skraćuje vek uređaja bez obzira na to koliko je kvalitetan uređaj kupljen."),
      h3("Korak 7: puštanje gasa i provera zaptivenosti"),
      p("Tek posle vakuuma se otvaraju ventili i gas iz spoljne jedinice se pušta u ceo sistem. Spojevi se proveravaju na curenje, najčešće penom ili detektorom. Ako je trasa duža od one koju fabrički punjenje pokriva, u tom trenutku se dodaje odgovarajuća količina gasa, i to se kaže i evidentira."),
      h3("Korak 8: puštanje u rad i primopredaja"),
      p("Uređaj se pušta u rad i pusti da radi dvadesetak minuta, dovoljno da se izmeri razlika temperature između vazduha koji ulazi i onog koji izlazi iz unutrašnje jedinice, i da se proveri pritisak u sistemu. Proverava se i da kondenzat zaista izlazi napolju."),
      p("Na kraju se prolazi kroz osnovno rukovanje daljinskim, objasni se kako i koliko često se peru filteri, i preda garancija na izvedene radove. Montaža koja se završava time što uređaj upali i duva hladno, bez ijednog merenja, nije završena nego prekinuta."),
      h2("Koliko traje i koliko je prljavo"),
      ...bullets([
        "Standardna montaža jednog uređaja u stanu: tri do četiri sata od dolaska do primopredaje",
        "Dva uređaja u istom stanu: najčešće jedan radni dan, jer se deo pripreme deli",
        "Debeo zid starije gradnje ili pozicija koja traži rad na visini: računajte sat do dva više",
        "Prašina nastaje samo pri bušenju prodora, traje nekoliko minuta i hvata se usisivačem",
        "Voda i struja se ne isključuju, potrebna je jedna utičnica za alat",
      ]),
      h2("Po čemu se poznaje da je montaža dobro odrađena"),
      p("Ovih pet stvari možete proveriti i sami, istog dana, bez ikakvog alata."),
      ...bullets([
        "Obe bakarne cevi su izolovane po celoj dužini, i unutra i napolju, bez golih delova",
        "Unutrašnja jedinica stoji u libelu, što se vidi golim okom u odnosu na liniju plafona",
        "Crevo za kondenzat nigde ne ide naviše i voda zaista kaplje napolju dok uređaj radi",
        "Prodor kroz zid je zatvoren i obrađen sa obe strane, ne ostavljen kao otvorena rupa",
        "Dobili ste garanciju na izvedene radove, a ne samo garantni list proizvođača za uređaj",
      ]),
      h2("Šta ulazi u cenu montaže"),
      p("U osnovnu cenu montaže kod nas ulazi standardna instalaciona trasa do tri metra sa bakarnim cevima i izolacijom, bušenje i obrada prodora, nosači i postavljanje obe jedinice, vakuumiranje sistema, puštanje u rad sa merenjem i garancija na izvedene radove. Doplaćuju se stavke koje zavise od objekta: svaki dužni metar trase preko tri metra, rad na visini i demontaža starog uređaja."),
      pl([
        "Konkretne iznose po kapacitetu, sa svim dodatnim stavkama, dali smo u tekstu ",
        { text: "cene montaže klime u Beogradu po kapacitetu", href: "/blog/cene-montaze-klime-u-beogradu-po-kapacitetu" },
        ". Ako još birate uređaj, počnite od ",
        { text: "vodiča za izbor klime za stan u Beogradu", href: "/blog/kako-izabrati-klimu-za-stan-u-beogradu" },
        ", jer pogrešno odabran kapacitet se ne može popraviti dobrom montažom.",
      ]),
      p("Poslednja napomena, iz iskustva. Razlika u ceni između uredne i brze montaže je po pravilu manja od cene jedne kasnije intervencije koju loša montaža izazove. Vakuumiranje, izolacija cele trase i pad odvoda su koraci koji se ne vide kad je posao gotov, i baš zato ih vredi pomenuti kad tražite ponudu, kod bilo kog izvođača."),
    ],
    faq: [
      { question: "Koliko traje ugradnja klime u stanu?", answer: "Standardna montaža jednog uređaja traje tri do četiri sata od dolaska do primopredaje. Dva uređaja u istom stanu su najčešće jedan radni dan, a debeo zid starije gradnje ili pozicija koja traži rad na visini dodaju sat do dva." },
      { question: "Šta treba da pripremim pre dolaska montažera?", answer: "Praktično ništa osim pristupa zidovima na kojima se radi. Ono što treba da odlučite unapred su pozicije unutrašnje i spoljne jedinice i da proverite da li vaša zgrada ima pravila o izgledu ili poziciji jedinica na fasadi, jer se te odluke posle montaže menjaju teško i uz trošak." },
      { question: "Da li je vakuumiranje sistema zaista neophodno?", answer: "Jeste, i to je korak koji se najčešće preskače kod najniže cene. Vazduh i vlaga zaostali u sistemu stvaraju kiseline koje izjedaju unutrašnjost, pa se posledica pojavi kroz godinu ili dve kao pad učinka i kvar kompresora. Vakuumiranje traje nekoliko desetina minuta, ne dva minuta." },
      { question: "Koliko je prljav posao ugradnja klime?", answer: "Prašina nastaje samo pri bušenju prodora kroz zid, traje nekoliko minuta i hvata se usisivačem na izlazu bušilice. Prostor ispod mesta bušenja se pokriva folijom, a nameštaj u blizini sklanja ili prekriva." },
      { question: "Kako da znam da je montaža dobro odrađena?", answer: "Proverite pet stvari istog dana: da su obe bakarne cevi izolovane po celoj dužini, da unutrašnja jedinica stoji u libelu, da crevo za kondenzat nigde ne ide naviše i da voda kaplje napolju, da je prodor obrađen sa obe strane, i da ste dobili garanciju na izvedene radove, a ne samo garantni list proizvođača." },
      { question: "Da li se voda ili struja isključuju tokom montaže?", answer: "Ne. Potrebna je jedna utičnica za alat i to je sve. Nema faze u kojoj stan ostaje bez vode ili struje." },
    ],
  },
];
