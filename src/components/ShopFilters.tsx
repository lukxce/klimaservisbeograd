      ...
      <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
        ...
        >
          <span className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-accent-dark">
            ...
            {activeCount > 0 && (
              <span className="rounded-lg bg-accent px-2 py-0.5 text-xs font-semibold text-white">
                {activeCount}
              </span>
            )}
          </span>
