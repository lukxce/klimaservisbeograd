              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {BRAND_HUBS.map((hub) => (
                  <Link
                    ...
                    className="rounded-lg border border-black/10 bg-white px-3 py-1.5 text-sm font-medium text-navy transition hover:border-accent-dark hover:text-accent-dark"
                  >
                    {hub.name}
                  </Link>
                ))}
